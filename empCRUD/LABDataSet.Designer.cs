...
namespace empCRUD {
    ...
    public partial class LABDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(int EmployeeID, string EmployeeName, int EmployeeSalary, string EmployeeCity) {
...
namespace empCRUD.LABDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_EmployeeName = 1 AND [EmployeeName] IS NULL) OR ([EmployeeName] = @Original_EmployeeName)) AND ((@IsNull_EmployeeSalary = 1 AND [EmployeeSalary] IS NULL) OR ([EmployeeSalary] = @Original_EmployeeSalary)) AND ((@IsNull_EmployeeCity = 1 AND [EmployeeCity] IS NULL) OR ([EmployeeCity] = @Original_EmployeeCity)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([EmployeeID], [EmployeeName], [EmployeeSalary], [EmployeeCity]) VALUES (@EmployeeID, @EmployeeName, @EmployeeSalary, @EmployeeCity);
SELECT EmployeeID, EmployeeName, EmployeeSalary, EmployeeCity FROM Employees WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [EmployeeID] = @EmployeeID, [EmployeeName] = @EmployeeName, [EmployeeSalary] = @EmployeeSalary, [EmployeeCity] = @EmployeeCity WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_EmployeeName = 1 AND [EmployeeName] IS NULL) OR ([EmployeeName] = @Original_EmployeeName)) AND ((@IsNull_EmployeeSalary = 1 AND [EmployeeSalary] IS NULL) OR ([EmployeeSalary] = @Original_EmployeeSalary)) AND ((@IsNull_EmployeeCity = 1 AND [EmployeeCity] IS NULL) OR ([EmployeeCity] = @Original_EmployeeCity)));
SELECT EmployeeID, EmployeeName, EmployeeSalary, EmployeeCity FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::empCRUD.Properties.Settings.Default.LABConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, EmployeeName, EmployeeSalary, EmployeeCity FROM dbo.Employees";
        ...
        public virtual int Fill(LABDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual LABDataSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LABDataSet.EmployeesDataTable dataTable = new LABDataSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LABDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_EmployeeName, global::System.Nullable<int> Original_EmployeeSalary, string Original_EmployeeCity) {
            ...
            if ((Original_EmployeeSalary.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_EmployeeSalary.Value));
            }
            else {
        ...
        public virtual int Insert(int EmployeeID, string EmployeeName, global::System.Nullable<int> EmployeeSalary, string EmployeeCity) {
        ...
        public virtual int Update(int EmployeeID, string EmployeeName, global::System.Nullable<int> EmployeeSalary, string EmployeeCity, int Original_EmployeeID, string Original_EmployeeName, global::System.Nullable<int> Original_EmployeeSalary, string Original_EmployeeCity) {
            ...
            if ((Original_EmployeeSalary.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_EmployeeSalary.Value));
            }
            else {
            ...
            if ((Original_EmployeeCity == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_EmployeeCity));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EmployeeName, global::System.Nullable<int> EmployeeSalary, string EmployeeCity, int Original_EmployeeID, string Original_EmployeeName, global::System.Nullable<int> Original_EmployeeSalary, string Original_EmployeeCity) {
            return this.Update(Original_EmployeeID, EmployeeName, EmployeeSalary, EmployeeCity, Original_EmployeeID, Original_EmployeeName, Original_EmployeeSalary, Original_EmployeeCity);
        }
    }
